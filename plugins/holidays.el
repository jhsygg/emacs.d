...
(defcustom holiday-bahai-holidays
  ...
  '((holiday-bahai-new-year)
    ...
    (holiday-fixed  5 23 "Declaration of the BÃ¡b")
    (holiday-fixed  5 29 "Ascension of BahÃ¡'u'llÃ¡h")
    (holiday-fixed  7  9 "Martyrdom of the BÃ¡b")
    (holiday-fixed 10 20 "Birth of the BÃ¡b")
    (holiday-fixed 11 12 "Birth of BahÃ¡'u'llÃ¡h")
    (if calendar-bahai-all-holidays-flag
        (append
         (holiday-fixed 11 26 "Day of the Covenant")
         (holiday-fixed 11 28 "Ascension of `Abdu'l-BahÃ¡")))))
  "BahÃ¡'Ã­ holidays.
See the documentation for `calendar-holidays' for details."
  :type 'sexp
  :group 'holidays)
...
Several basic functions are provided for this purpose:
    ...
    (holiday-bahai MONTH DAY STRING)   a fixed date on the BahÃ¡'Ã­ calendar
...
To add an entry for the BahÃ¡'Ã­ festival of Ridvan, use

     (holiday-bahai 2 13 \"Festival of Ridvan\")

since the BahÃ¡'Ã­ months are numbered from 1 starting with BahÃ¡.
          ...
          (lists
           (list
            ...
            (if holiday-bahai-holidays
                (cons "BahÃ¡'Ã­" holiday-bahai-holidays))
