...
(let ((minver 24))
  (unless (>= emacs-major-version minver)
    (error "Your Emacs is too old -- this config requires v%s or highter" minver)))
...
(custom-set-variables
 ...
 '(display-time-mode t)
 '(erc-autojoin-channels-alist (quote (("linuxsir.org" "#javalee") ("irc.linuxfans.org" "#linuxfans" "#linuxer"))))
 ...
 '(matlab-mode-install-path "~/.emacs.d/plugins")
